...
@Component({
  ...
  standalone:true,
  imports: [EtudiantBannerComponent, DatePipe, TitleCasePipe, PublierDemandeDonsComponent],
...
export class DemandeDonsEtudiantComponent implements OnInit {
  ...
  demandesDons:any;
  constructor(private demandeService: DemandeDonService,private cdr : ChangeDetectorRef) {}
