...
import { SocialUser, SocialAuthService, GoogleLoginProvider, SocialLoginModule } from 'angularx-social-login';

@Component({
  selector: 'app-registration',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, PasswordStrengthMeterComponent, SocialLoginModule],
